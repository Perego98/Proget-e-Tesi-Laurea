CREATE DATABASE  IF NOT EXISTS `gestione_candidature` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestione_candidature`.`sede` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestione_candidature`.`utente` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestione_candidature`.`Candidato` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestione_candidature`.`schedaValutazione` ;
...
CREATE TABLE IF NOT EXISTS `gestione_candidature`.`schedaValutazione` (
  ...
  CONSTRAINT `fk_candidato`
    ...
    REFERENCES `gestione_candidaturecandidato`.`Candidato` (`codiceFiscale`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE)
ENGINE = InnoDB;
