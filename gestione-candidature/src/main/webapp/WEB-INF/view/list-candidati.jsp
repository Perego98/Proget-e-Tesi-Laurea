			...
			<table class="table table-striped">
				...
				<tbody id="myTable">
					...
					<c:forEach var="tempCandidato" items="${candidati}">
						...
						<!-- Delete Modal -->
						<div id="Delete${tempCandidato.codiceFiscale}" class="modal fade"
							role="dialog">
							<div class="modal-dialog">
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<p>Attenzione! Cliccando Elimina questo account verrà
											Eliminato</p>
										<br>
										<p>Una volta eliminato non sarà più possibile recuperare i
											dati</p>
									</div>
									<div class="modal-footer">
										<button type="button" class="btn btn-danger"
											data-dismiss="modal"
											onclick="window.location.href='${pageContext.request.contextPath}/hr/deleteCandidato?codFiscale=${tempCandidato.codiceFiscale}'">Elimina</button>
								...
								<td>
									<h5>
										<span data-toggle="tooltip"
											title="Nessun Supervisore Associato"
											class="label label-warning">Attenzione</span>
									</h5>
								</td>
							</c:if>
							...
							<td>
								...
								<div class="dropdown">
									<button class="btn btn-primary dropdown-toggle" type="button"
										...
										Aggiorna / Info / Elimina <span class="caret"></span>
									</button>
									<ul class="dropdown-menu">
										<li class="dropdown-header">Aggiorna</li>
										<li><a
											href="${pageContext.request.contextPath}/hr/showCandidatoUpdateForm?codFiscale=${tempCandidato.codiceFiscale}">Aggiorna
												Info</a></li>
										<li><a
											href="${pageContext.request.contextPath}/hr/showCandidatoUpdateStatoForm?codFiscale=${tempCandidato.codiceFiscale}">Aggiorna
												Stato</a></li>
										<li><a
											href="${pageContext.request.contextPath}/hr/showCandidatoSetManagerForm?codFiscale=${tempCandidato.codiceFiscale}">Assegna
												a Manager</a></li>
										<li><a
											href="${pageContext.request.contextPath}/hr/showUploadCV?codFiscale=${tempCandidato.codiceFiscale}">Upload
												CV</a></li>
										<li><a
											href="${pageContext.request.contextPath}/hr/showCompilazioneSchedaValutazioneForm?codFiscale=${tempCandidato.codiceFiscale}">Compila
												Scheda Val.</a></li>

										<li class="divider"></li>
										<li class="dropdown-header">Info</li>
										<li><a
											href="${pageContext.request.contextPath}/hr/showMoreInfoCandidato?codFiscale=${tempCandidato.codiceFiscale}">Mostra
												più Info</a></li>
										<li class="divider"></li>
										...
										<li><a onclick="#Delete${tempCandidato.codiceFiscale}"
											data-toggle="modal"
											data-target="#Delete${tempCandidato.codiceFiscale}">Elimina
												Candidato</a></li>
									</ul>
								</div> 
							</td>
