...
<div class="panel panel-default">
		...
		<form:form action="${pageContext.request.contextPath}/hr/processUpdateStatoCandidatoForm?codFiscale=${candidato.codiceFiscale}" modelAttribute="candidato" method="POST">
